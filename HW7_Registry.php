...
// Объявлен класс  Реестра для дальнейшего использования в паттерне управления активными компонентами!
// В частности вызов контейнера загрузки и установление зависимостей
// получение параметров страницы для построения маршрутов,
//
//Соответственно обращение к реестру происходит где-то в точке входа index  и тд
